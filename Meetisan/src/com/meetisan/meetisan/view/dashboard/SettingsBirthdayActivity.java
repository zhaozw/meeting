...
import com.meetisan.meetisan.widget.wheel.CustomizedBirthdayWheelView;
 ...
 * 
 */
public class SettingsBirthdayActivity extends Activity {
	...
	private void initView() {
		...
		mCompleteBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				SettingsBirthdayActivity.this.setResult(0, mIntent);
				finish();
			}
		});
	}
