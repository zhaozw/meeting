...
public class TagAssociatedMeetingsActivity extends Activity {
	private static final String TAG = TagAssociatedMeetingsActivity.class.getSimpleName();
	...
	private void initView() {
		...
		mTitleTxt.setText(R.string.meetings_associated);
		mTitleTxt.setVisibility(View.VISIBLE);
		ImageButton mBackBtn = (ImageButton) findViewById(R.id.btn_title_left);
		mBackBtn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				TagAssociatedMeetingsActivity.this.finish();
			}
		});
		...
		mMeetingsListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				intent.setClass(TagAssociatedMeetingsActivity.this, MeetProfileActivity.class);
	...
	private void getMeetingsFromServer(int pageIndex, int orderType, float mLat, float mLon, final boolean isRefresh,
		...
		request.get(ServerKeys.FULL_URL_GET_ASSOCIATE_MEET + "/?pageindex=" + pageIndex + "&pagesize="
