...
public class TagAssociatedPeopleActivity extends Activity implements OnClickListener {
	private static final String TAG = TagAssociatedPeopleActivity.class.getSimpleName();
	...
	private void initView() {
		...
		((TextView) findViewById(R.id.txt_title)).setText(R.string.people_associated);
		...
		mPeopleListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				intent.setClass(TagAssociatedPeopleActivity.this, PersonProfileActivity.class);
	...
	private void getPeoplesFromServer(int pageIndex, final boolean isRefresh, final boolean isNeedsDialog) {
		...
		request.get(
				ServerKeys.FULL_URL_GET_UESR_LIST + "/" + mUserInfo.getId() + "/?pageindex=" + pageIndex + "&pagesize="
						+ ServerKeys.PAGE_SIZE + "&lat=" + mUserInfo.getLatitude() + "&lon=" + mUserInfo.getLongitude()
						+ "&tagIDs=" + mTagID + "&name=", null);
