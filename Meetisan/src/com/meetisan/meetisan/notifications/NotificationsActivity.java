...
public class NotificationsActivity extends Activity implements OnItemClickListener {
	...
	private void getNotificationsFromServer(int pageIndex, final boolean isRefresh,
			...
			public void onSuccess(String url, String result) {
				...
				try {
					...
					for (int i = 0; i < notificationArray.length(); i++) {
						...
						JSONObject peopleJson = notificationArray.getJSONObject(i);
		...
		request.get(ServerKeys.FULL_URL_GET_NOTIFICATION + "/" + mUserId + "/?pageindex=" + pageIndex
