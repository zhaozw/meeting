package com.meetisan.meetisan.widget.listview.refresh;
...
public class DropDownListView extends ListView implements OnScrollListener {
	...
	private void getAttrs(Context context, AttributeSet attrs) {
		TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.DropListView);
		isDropDownStyle = ta.getBoolean(R.styleable.DropListView_isDropDownStyle, false);
		isOnBottomStyle = ta.getBoolean(R.styleable.DropListView_isOnBottomStyle, false);
		isAutoLoadOnBottom = ta.getBoolean(R.styleable.DropListView_isAutoLoadOnBottom, false);
		ta.recycle();
	}
}
